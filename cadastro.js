...
export const cadastro = { //transformando a array em objeto
    pessoas: [ //atributo pessoas e o conteudo dele é o array de objetos que tinhamos antes
        {
            nome: "Laila Cardoso",
            cidade: "Salvador",
            idade: 19,
     ...
     adicionar: function (pessoa) { //adicionar método 
          this.pessoas.push(pessoa) //inserindo a pessoa na array
